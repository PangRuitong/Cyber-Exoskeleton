...
drop trigger if exists enrich_thought_after_insert on public.thoughts;

create trigger enrich_thought_after_insert
after insert on public.thoughts
for each row
execute function public.enqueue_thought_enrichment_webhook();
